...
var root_3 = $.from_html(`<span class="dot busy"></span>`);
...
var root_4 = $.from_html(`<div class="browser-tab active"><span class="tab-initial"><!></span><span>New tab</span></div>`);
var root_6 = $.from_html(`<div class="browser-tab active"><span class="tab-initial"><!></span><span class="truncate"> </span><button class="tab-close" style="margin-left:auto" aria-label="Return to browser"><!></button></div>`);
var root_7 = $.from_html(`<button class="icon-button" style="width:23px;height:23px;min-width:23px;min-height:23px" type="button" aria-label="Copy website URL"><!></button>`);
var root_8 = $.from_html(`<form class="findbar"><!><input aria-label="Find on page" placeholder="Find on this page" maxlength="256"/><small>Enter to find next</small><button type="button" class="icon-button" aria-label="Previous match"><!></button><button class="icon-button" aria-label="Next match"><!></button><button type="button" class="icon-button" aria-label="Close find"><!></button></form>`);
var root_9 = $.from_html(`<div class="resize-handle" role="slider" tabindex="0" aria-label="Sidebar width" aria-orientation="vertical" aria-valuemin="180" aria-valuemax="320"></div>`);
var root_10 = $.from_html(`<div style="width:1px;background:var(--line)"></div>`);
...
var root_13 = $.from_html(`<div class="layout-notice" role="status"><!><span> </span><button class="icon-button" aria-label="Dismiss notification"><!></button></div>`);
...
var root_32 = $.from_html(`<kbd>↵</kbd>`);
var root_31 = $.from_html(`<button><!><span><strong> </strong><small> </small></span><!></button>`);
var root_33 = $.from_html(`<p class="muted" style="padding:20px 5px">No matching commands.</p>`);
...
var root_37 = $.from_html(`<div class="shortcut-row"><span> </span><kbd> </kbd></div>`);
var root_36 = $.from_html(`<!><p class="field-hint" style="margin-top:18px">Address and command shortcuts also work while a provider page has focus. Other shortcuts may be handled by the website.</p>`, 1);
var root_40 = $.from_html(`<p class="dialog-description"> </p><div class="dialog-actions"><button class="secondary">Cancel</button><button class="primary danger"> </button></div>`, 1);
...
export default function App($$anchor, $$props) {
...

	{
		...
		var alternate = ($$anchor) => {
...

			{
				var consequent_3 = ($$anchor) => {
					...
					var text_2 = $.child(span_6, true);

					$.reset(span_6);

					var button_2 = $.sibling(span_6);
				...
				$.if(
					node_7,
					($$render) => {
						if (app.route !== 'browser') $$render(consequent_3);
					},
					true
				);
			}
		...
		$.if(node_5, ($$render) => {
			if (app.selectedProvider === null && app.route === 'browser') $$render(consequent_2); else $$render(alternate, false);
		});
	}
...

	{
		...
		$.if(node_19, ($$render) => {
			if (app.provider) $$render(consequent_4);
		});
	}
...

	{
		...
		$.if(node_29, ($$render) => {
			if (app.sidebarVisible) $$render(consequent_6); else $$render(alternate_1, false);
		});
	}
...

	{
		var consequent_7 = ($$anchor) => {
			...
			var span_9 = $.sibling(node_31);
			var text_4 = $.child(span_9, true);

			$.reset(span_9);

			var button_18 = $.sibling(span_9);
...

	{
		var consequent_8 = ($$anchor) => {
			...
			var span_10 = $.sibling(node_33);
			var text_5 = $.child(span_10, true);

			$.reset(span_10);

			var button_19 = $.sibling(span_10);
		...
		$.if(node_32, ($$render) => {
			if (app.error) $$render(consequent_8);
		});
	}
...

	{
		var consequent_9 = ($$anchor) => {
			...
			var span_11 = $.sibling(node_36);
			var text_6 = $.child(span_11, true);

			$.reset(span_11);

			var button_20 = $.sibling(span_11);
		...
		$.if(node_35, ($$render) => {
			if (app.notification) $$render(consequent_9);
		});
	}
...

	{
		...
		var alternate_7 = ($$anchor) => {
...

			{
				...
				var alternate_6 = ($$anchor) => {
...

					{
						...
						var alternate_5 = ($$anchor) => {
...

							{
								...
								var alternate_4 = ($$anchor) => {
...

									{
										...
										var alternate_3 = ($$anchor) => {
...

											{
												...
												$.if(
													node_43,
													($$render) => {
														if (app.route === 'settings') $$render(consequent_15); else $$render(alternate_2, false);
													},
													true
												);
											}
										...
										$.if(
											node_42,
											($$render) => {
												if (app.route === 'detector') $$render(consequent_14); else $$render(alternate_3, false);
											},
											true
										);
									}
								...
								$.if(
									node_41,
									($$render) => {
										if (app.route === 'harness') $$render(consequent_13); else $$render(alternate_4, false);
									},
									true
								);
							}
						...
						$.if(
							node_40,
							($$render) => {
								if (app.route === 'sessions') $$render(consequent_12); else $$render(alternate_5, false);
							},
							true
						);
					}
				...
				$.if(
					node_39,
					($$render) => {
						if (app.route === 'models') $$render(consequent_11); else $$render(alternate_6, false);
					},
					true
				);
			}
		...
		$.if(node_38, ($$render) => {
			if (app.route === 'browser') $$render(consequent_10); else $$render(alternate_7, false);
		});
	}
	...
	var span_13 = $.sibling(button_21, 2);
	var text_8 = $.child(span_13);

	$.reset(span_13);

	var button_22 = $.sibling(span_13, 2);
	...
	var span_14 = $.sibling(button_22, 2);
	var text_10 = $.child(span_14, true);

	$.reset(span_14);

	var node_44 = $.sibling(span_14, 2);
...

	{
		...
		var alternate_10 = ($$anchor) => {
...

			{
				...
				var alternate_9 = ($$anchor) => {
...

					{
								...
								children: ($$anchor, $$slotProps) => {
									...
									$.each(
										...
										($$anchor, $$item) => {
											...
											let key = () => $.get($$array)[1];
											var div_20 = root_37();
											var span_16 = $.child(div_20);
											var text_13 = $.child(span_16, true);
						...
						$.if(
							node_54,
							($$render) => {
								if (app.popup === 'shortcuts') $$render(consequent_20); else $$render(alternate_8, false);
							},
							true
						);
					}
				...
				$.if(
					node_48,
					($$render) => {
						if (app.popup === 'commands') $$render(consequent_19); else $$render(alternate_9, false);
					},
					true
				);
			}
		...
		$.if(node_45, ($$render) => {
			if (app.popup === 'add') $$render(consequent_16); else $$render(alternate_10, false);
		});
	}
	...
	$.template_effect(
		($0) => {
			...
			classes_3 = $.set_class(span_7, 1, 'dot', null, classes_3, { online: $.get(online) });
			$.set_text(text_3, app.snapshot?.api.port ?? 7331);
			$.set_attribute(button_13, 'aria-pressed', app.inspectorVisible);
			classes_5 = $.set_class(span_12, 1, 'dot', null, classes_5, { online: $.get(online) });
