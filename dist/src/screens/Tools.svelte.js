...
var root = $.from_html(`<button class="secondary">Tool library</button><details class="setup-menu"><summary>More setup</summary><div><button class="secondary">Import configuration</button><button class="secondary"><!>Add tool server</button></div></details>`, 1);
var root_1 = $.from_html(`<p class="error-banner" role="alert"> </p>`);
var root_2 = $.from_html(`<div class="task-pause"><p>Reached the chosen work budget at a safe boundary. Your conversation, pending call and last result are retained. No completed tool is replayed.</p><button class="primary"> </button><p class="field-hint">Continuing renews the work budget, not tool permissions. Broader grants must be approved again. Progress is retained in this app session, not after a restart.</p></div>`);
var root_3 = $.from_html(`<div class="task-running" role="status"><span class="mini-working" aria-hidden="true"></span><span> </span></div>`);
var root_4 = $.from_html(`<div class="tool-call"><div class="section-title"><h3>Approve this tool call</h3><!></div><p><strong> </strong> </p><pre class="code"> </pre><p class="field-hint"> </p> <details class="advanced-client"><summary>Advanced · automatic execution for this task</summary><label class="setting-line"><div><strong>Allow this tool for the rest of this task</strong><p>Includes future calls with different arguments. This is not a path-limited file permission. The grant ends at the next work-budget pause, after 30 minutes, when the task ends, or when the connection changes.</p></div><input type="checkbox" aria-label="Allow MCP tool for task"/></label></details> <div class="button-group"><button class="primary"> </button><button class="secondary">Deny and stop</button></div></div>`);
var root_5 = $.from_html(`<p>The approved tool finished. Send its result to continue the website conversation.</p><button class="primary">Insert result and send</button>`, 1);
var root_6 = $.from_html(`<pre class="tool-answer"> </pre>`);
var root_7 = $.from_html(`<details class="advanced-client"><summary>Last tool result · untrusted data</summary><pre class="code"> </pre></details>`);
var root_8 = $.from_html(`<div class="button-group" style="margin-top:15px"><button class="secondary danger-text">Stop task and revoke permissions</button><button class="text-button">Show website</button></div>`);
var root_9 = $.from_html(`<section class="section task-activity" aria-label="MCP task activity"><div class="section-title"><h2>Task activity</h2><span> </span></div> <!> <!> <!> <!> <!> <!> <!> <!></section>`);
var root_10 = $.from_html(`<option>Select an available model</option>`);
var root_11 = $.from_html(`<option> </option>`);
var root_12 = $.from_html(`<button class="text-button">Show website</button>`);
var root_13 = $.from_html(`<section class="section"><div class="section-title"><h2>Start a task</h2><span class="tag"> </span></div> <label class="field"><span>Website model</span><select aria-label="MCP website model"><!><!></select></label> <label class="field"><span>What should the model do?</span><textarea aria-label="MCP task" maxlength="8191" rows="3" placeholder="Describe a task for the selected website model"></textarea><span class="field-hint">Your task, enabled tool descriptions and approved results are shared with the selected website. Drafts stay in memory until you close the application.</span></label> <details class="advanced-client task-options"><summary>Task options</summary><label class="setting-line"><div><strong>Automatically continue after approved tools</strong><p>Insert results and send the next turn. Tool execution still requires your approval.</p></div><input type="checkbox" aria-label="Automatically continue tool results"/></label> <div class="budget-fields"><label class="field"><span>Model turns per work budget</span><input type="number" aria-label="Task turn budget" min="10" max="500" step="1"/></label><label class="field"><span>Active minutes per work budget</span><input type="number" aria-label="Task work minutes" min="5" max="240" step="1"/></label></div> <p class="field-hint">Waiting for your approval does not spend the work budget. A running tool is not interrupted when the budget ends; the task pauses at its next safe boundary. Site quotas, context limits and stalled connections still apply.</p></details> <div class="button-group"><button class="primary"><!> </button><!></div> <p class="field-hint" role="status" style="margin-top:12px"> </p></section>`);
var root_14 = $.from_html(`<section class="section"><div class="section-title"><h2>Tool library</h2><button class="text-button">Close library</button></div><!></section>`);
var root_15 = $.from_html(`<label class="field"><span>Imported definition</span><select></select><span class="field-hint">Command and arguments only. No credentials or environment values are copied.</span></label>`);
var root_16 = $.from_html(`<p class="form-error" role="alert"> </p>`);
var root_17 = $.from_html(`<section class="section" aria-label="MCP server editor"><h2>Add an MCP server</h2><form><!> <label class="field"><span>Name</span><input aria-label="MCP server name" maxlength="120" required=""/></label> <label class="field"><span>Executable</span><input class="mono" aria-label="MCP executable" maxlength="2000" required=""/><span class="field-hint">An installed command or absolute executable path. Arguments go below; do not paste a shell command.</span></label> <label class="field"><span>Arguments · JSON array</span><textarea class="mono" aria-label="MCP arguments" rows="3"></textarea></label> <!> <div class="button-group"><button class="primary"> </button><button type="button" class="secondary">Cancel</button></div></form></section>`);
var root_18 = $.from_html(`<section tabindex="-1" class="section permission-box" aria-label="Local process permission"><div class="section-title"><h2>Allow this local process?</h2><!></div><p><strong> </strong> runs with your computer user account’s access. A package runner may download code. Tool approval does not sandbox the server itself.</p><pre class="code"> </pre><label class="setting-line"><span>I trust this executable and its arguments.</span><input type="checkbox" aria-label="Trust MCP executable"/></label><div class="button-group"><button class="primary"> </button><button class="secondary">Do not run</button></div></section>`);
var root_19 = $.from_html(`<div class="discovery-note"><!><div>No tool servers configured. Import an existing MCP configuration or add a trusted executable. Your coding client’s model connection does not require an MCP server.</div></div>`);
var root_20 = $.from_html(`<button class="secondary">Connect</button>`);
var root_21 = $.from_html(`<button class="secondary">Disconnect</button>`);
var root_22 = $.from_html(`<label class="setting-line"><div><strong> </strong><p> </p></div><input type="checkbox"/></label>`);
var root_23 = $.from_html(`<p class="field-hint">No tools match. <button class="text-button">Clear filter</button></p>`);
var root_24 = $.from_html(`<details class="advanced-client tool-catalog"><summary> </summary><label class="field"><span>Find a tool</span><input type="search"/></label> <!><!><p class="field-hint">Up to 32 enabled tools within the shared schema budget. Descriptions are sent to the website when a task starts.</p></details>`);
var root_25 = $.from_html(`<details><summary> </summary><pre class="code"> </pre></details>`);
var root_26 = $.from_html(`<div class="tool-server"><div class="section-title"><div><strong> </strong><p class="field-hint"> </p></div><div class="button-group"><!></div></div> <!> <!> <details class="advanced-client"><summary>Advanced · executable and tool schemas</summary><p class="field-hint"> </p><pre class="code"> </pre><!><p class="field-hint">Descriptions are supplied by the server, not a security guarantee. Reconnecting or a changed catalog resets enabled choices and task grants.</p><button class="text-button danger-text">Remove server</button></details></div>`);
var root_27 = $.from_html(`<section class="section"><div class="section-title"><h2>Tool servers</h2><span class="tag"> </span></div> <!> <!></section>`);
var root_28 = $.from_html(`<section class="screen"><div class="screen-inner tools-screen"><header class="screen-head"><div><div class="breadcrumb">Codemax / Website tasks</div><h1>Website tasks</h1><p>Choose a task and its tools. Approve access, then let the same conversation continue.</p></div><div class="button-group"><!></div></header> <!> <!> <!> <!> <!> <!></div></section>`);
...
export default function Tools($$anchor, $$props) {
...

	{
		var consequent = ($$anchor) => {
			...
			$.delegated('click', button_1, importServers);
			$.delegated('click', button_2, () => $.get(draft).adding = !$.get(draft).adding);
...

	{
		var consequent_9 = ($$anchor) => {
...

			{
				...
				var d = $.derived(() => $.get(run).error && !['CANCELLED', 'PAUSED'].includes($.get(run).state));
...

			{
				var consequent_2 = ($$anchor) => {
					...
					$.delegated('click', button_3, () => app.perform('mcp.run.resume', { run_id: $.get(run).id }));
					$.append($$anchor, div_4);
				};
...

			{
				var consequent_4 = ($$anchor) => {
					...
					var text_8 = $.only_child(button_4, true);
					...
					$.delegated('click', button_4, approve);
...

			{
				var consequent_5 = ($$anchor) => {
					...
					$.delegated('click', button_6, () => app.perform('mcp.run.continue', { run_id: $.get(run).id }));
...

			{
				var consequent_8 = ($$anchor) => {
					...
					$.delegated('click', button_7, cancel);
					$.delegated('click', button_8, () => app.openProvider($.get(run).provider_id));
					$.append($$anchor, div_9);
				};
...

	{
		var consequent_12 = ($$anchor) => {
			...
			$.each(node_14, 17, () => app.exposedModels, (item) => item.id, ($$anchor, item) => {
				...
				var text_12 = $.only_child(option_1);
				var option_1_value = {};
...

			{
				var consequent_11 = ($$anchor) => {
					...
					$.delegated('click', button_10, () => app.openProvider($.get(model).provider.id));
			...
			var text_14 = $.only_child(p_4, true);
			...
			$.delegated('change', select, (e) => $.get(draft).chosen = e.currentTarget.value);
			...
			$.delegated('click', button_9, start);
...

	{
		var consequent_13 = ($$anchor) => {
			...
			$.reset(section_3);
			$.delegated('click', button_11, () => $.set(library, false));
		...
		var consequent_16 = ($$anchor) => {
...

			{
				var consequent_14 = ($$anchor) => {
					...
					$.each(select_1, 21, () => $.get(imported), $.index, ($$anchor, definition, i) => {
						...
						var text_15 = $.only_child(option_2, true);
					...
					$.next();
					$.reset(label_6);
					$.delegated('change', select_1, useImported);
...

			{
				var consequent_15 = ($$anchor) => {
					var p_5 = root_16();
					var text_16 = $.only_child(p_5, true);
			...
			$.delegated('click', button_13, () => $.get(draft).adding = false);
...

	{
		var consequent_17 = ($$anchor) => {
			...
			var text_20 = $.only_child(button_14, true);
...
${$0 ?? ''}`);
			...
			$.delegated('click', button_14, connect);
		...
		var consequent_23 = ($$anchor) => {
			...
			$.each(node_27, 17, () => $.get(servers), (server) => server.id, ($$anchor, server) => {
...

				{
					...
					var d_1 = $.derived(() => ['DISCONNECTED', 'ERROR'].includes($.get(server).state));

					var alternate = ($$anchor) => {
						var button_17 = root_21();

						$.template_effect(($0) => button_17.disabled = $0, [
							() => $.get(running) || !app.ready || app.busy('mcp.server.connect')
						]);

						$.delegated('click', button_17, () => app.perform('mcp.server.disconnect', { server_id: $.get(server).id }));
						$.append($$anchor, button_17);
					};

					$.if(node_28, ($$render) => {
						if ($.get(d_1)) $$render(consequent_19); else $$render(alternate, -1);
					});
				}
...

				{
					var consequent_20 = ($$anchor) => {
						var p_8 = root_1();
						var text_24 = $.only_child(p_8, true);
...

				{
					var consequent_22 = ($$anchor) => {
						var details_4 = root_24();
						var summary = $.child(details_4);
						var text_25 = $.only_child(summary);
						...
						$.each(node_31, 17, () => $.get(server).tools.filter((t) => `${t.name} ${t.description}`.toLowerCase().includes($.get(toolFilter).toLowerCase())), (tool) => tool.alias, ($$anchor, tool) => {
							var label_12 = root_22();
							var div_23 = $.child(label_12);
							var strong_3 = $.child(div_23);
							var text_26 = $.only_child(strong_3, true);
							var p_9 = $.sibling(strong_3);
							var text_27 = $.only_child(p_9, true);
...

						{
							var consequent_21 = ($$anchor) => {
								...
								$.reset(p_10);
								$.delegated('click', button_18, () => $.set(toolFilter, ''));
								$.append($$anchor, p_10);
							};

							var d_2 = $.derived(() => !$.get(server).tools.some((t) => `${t.name} ${t.description}`.toLowerCase().includes($.get(toolFilter).toLowerCase())));
...
${$3 ?? ''}`);
				...
				$.delegated('click', button_19, () => remove($.get(server)));
