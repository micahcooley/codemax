...
var root_2 = $.from_html(`<div class="empty-website"><div class="new-site-content"><div class="new-site-mark"><!><span class="label">Your browser. Your models.</span></div><h1>Open a website.<br/>Connect what’s already yours.</h1><p>Use your AI websites in a dedicated browser, then make their models available to your local coding tools.</p><form class="new-site-form"><!><input aria-label="Website to open" placeholder="Enter an AI chat website" autocomplete="url" spellcheck="false" maxlength="2048" required/><button class="primary" aria-label="Open website"><!></button></form><div class="site-shortcuts"></div><div class="start-footer"><!><span>Sign in on the website itself. Passwords, cookies, and authentication tokens stay in the provider’s isolated browser profile.</span></div></div></div>`);
