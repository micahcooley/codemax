...
var root_10 = $.from_html(`<option>No saved website profiles</option>`);
var root_11 = $.from_html(`<option> </option>`);
var root_13 = $.from_html(`<div class="setting-row"><div><strong>Model and reasoning options</strong><p>Exposure, context overrides and model preferences live in Provider settings.</p></div><button class="secondary">Provider settings</button></div>`);
var root_12 = $.from_html(`<div class="setting-row"><div><strong>Display name</strong><p> </p></div><input aria-label="Website display name" maxlength="120"/></div><div class="setting-row"><div><strong>Keep this website awake</strong><p>Kept-awake profiles are excluded from idle suspension.</p></div><button class="toggle" role="switch" aria-label="Keep website awake"></button></div><!><div class="setting-row"><div><strong>Clear local profile</strong><p>Delete this website’s local storage and sign out of this profile. Remote account data is not deleted.</p></div><button class="secondary">Clear storage</button></div><div class="setting-row"><div><strong>Remove website</strong><p>Remove the profile and connector from the workspace and end associated sessions.</p></div><button class="secondary danger-text">Remove</button></div>`, 1);
var root_14 = $.from_html(`<p>No website profiles have been added.</p>`);
...
export default function Settings($$anchor, $$props) {
	...
	$.each(nav, 21, () => sections, $.index, ($$anchor, section) => {
		...
		button.__click = () => app.settingsSection = $.get(section).id;
		...
		var alternate_4 = ($$anchor) => {
...

			{
				var consequent_1 = ($$anchor) => {
					...
					button_6.__click = () => app.snapshot?.api.running
				...
				var alternate_3 = ($$anchor) => {
...

					{
						var consequent_5 = ($$anchor) => {
							...
							var node_9 = $.child(select_3);

							{
								var consequent_2 = ($$anchor) => {
									var option_10 = root_10();
							...
							$.each(node_10, 17, () => app.providers, $.index, ($$anchor, p) => {
								var option_11 = root_11();
...

							{
								...
								$.if(node_11, ($$render) => {
									if ($.get(profile)) $$render(consequent_4); else $$render(alternate, false);
								});
							}
						...
						var alternate_2 = ($$anchor) => {
...

							{
								var consequent_6 = ($$anchor) => {
									...
									var node_14 = $.sibling($.child(div_24));

									Icon(node_14, { name: 'lock', size: 17 });
									$.reset(div_24);
									$.next(2);
									$.reset(section_7);

									var section_8 = $.sibling(section_7);
									var div_25 = $.sibling($.child(section_8));
									var select_4 = $.sibling($.child(div_25));
								...
								var alternate_1 = ($$anchor) => {
									...
									var div_28 = $.sibling($.child(section_9));
									var div_29 = $.child(div_28);
									var p_3 = $.sibling($.child(div_29));
									var text_7 = $.child(p_3, true);

									$.reset(p_3);
									$.reset(div_29);

									var span = $.sibling(div_29);
									let classes_2;
									...
									var div_31 = $.sibling(div_30);
									var button_17 = $.sibling($.child(div_31));

									button_17.__click = restart;

									var node_15 = $.child(button_17);

									Icon(node_15, { name: 'refresh', size: 14 });

									var text_10 = $.sibling(node_15, 1, true);

									$.reset(button_17);
									$.reset(div_31);

									var div_32 = $.sibling(div_31);
									var button_18 = $.sibling($.child(div_32));
									...
									var div_33 = $.sibling(p_4);
									var node_16 = $.child(div_33);

									Icon(node_16, { name: 'shield', size: 16 });
									$.next();
									$.reset(div_33);
									$.reset(section_10);
								...
								$.if(
									node_13,
									($$render) => {
										if ($.get(tab) === 'privacy') $$render(consequent_6); else $$render(alternate_1, false);
									},
									true
								);
							}
						...
						$.if(
							node_7,
							($$render) => {
								if ($.get(tab) === 'profiles') $$render(consequent_5); else $$render(alternate_2, false);
							},
							true
						);
					}
