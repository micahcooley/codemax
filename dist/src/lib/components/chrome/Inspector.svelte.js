...
var root_8 = $.from_html(`<aside class="inspector" aria-label="Connection inspector"><div class="inspector-head"><div class="inspector-tabs"><button>Connection</button><button>Browser</button></div><button class="icon-button" aria-label="Close inspector"><!></button></div> <!></aside>`);
...
export default function Inspector($$anchor, $$props) {
...

	{
		var consequent_3 = ($$anchor) => {
...

			{
				var consequent_2 = ($$anchor) => {
...

					{
						var consequent = ($$anchor) => {
							...
							var text_4 = $.only_child(dd, true);
							var dd_1 = $.sibling(dd, 2);
							var text_5 = $.only_child(dd_1, true);
							var dd_2 = $.sibling(dd_1, 2);
							var text_6 = $.only_child(dd_2, true);
							var dd_3 = $.sibling(dd_2, 2);
							var text_7 = $.only_child(dd_3, true);
							...
							$.delegated('click', button_3, () => app.navigate('harness'));
							$.delegated('click', button_4, () => app.navigate('providers'));
							$.delegated('click', button_5, () => app.navigate('tools'));
							$.append($$anchor, div_4);
						};
						...
						$.if(node_3, ($$render) => {
							if ($.get(p).detected && !$.get(p).dismissed) $$render(consequent); else $$render(alternate, -1);
						});
					}
					...
					$.each(node_7, 16, () => essentials, (role) => role, ($$anchor, role) => {
						...
						$.delegated('click', button_6, () => app.pick(role));
...

					{
						var consequent_1 = ($$anchor) => {
							...
							var text_10 = $.only_child(dd_4, true);
							var dd_5 = $.sibling(dd_4, 2);
							var text_11 = $.only_child(dd_5, true);
							...
							$.delegated('click', button_8, () => app.cancel($.get(active).id));
						...
						$.if(node_10, ($$render) => {
							if ($.get(active)) $$render(consequent_1); else $$render(alternate_1, -1);
						});
					}
					...
					$.delegated('click', button_7, () => app.perform('provider.rescan', { provider_id: $.get(p).id }));
					$.delegated('click', button_9, () => app.navigate('sessions'));
				...
				var alternate_2 = ($$anchor) => {
					...
					var text_12 = $.only_child(button_15);
					...
					$.delegated('click', button_10, () => app.perform('provider.home', { provider_id: $.get(p).id }));
					$.delegated('click', button_11, () => app.control('external'));

					$.delegated('click', button_12, () => {
						app.showFind();
					});

					$.delegated('click', button_13, () => app.clipboard(app.pageUrl));
					$.delegated('click', button_14, () => app.control('zoom_out'));
					$.delegated('click', button_15, () => app.control('zoom_reset'));
					$.delegated('click', button_16, () => app.control('zoom_in'));
					$.delegated('click', button_17, () => app.control('popup_once'));
					$.delegated('click', button_18, () => app.control('download_once'));
					$.delegated('click', button_19, () => app.perform('provider.update', { provider_id: $.get(p).id, pinned: !$.get(p).pinned }));
					$.delegated('click', button_20, () => app.showPopup('clear-profile', $.get(p).id));
					$.delegated('click', button_21, () => app.closeProvider($.get(p).id));
					$.delegated('click', button_22, () => app.control('inspect'));
					$.delegated('click', button_23, () => app.navigate('detector'));
					$.append($$anchor, fragment_3);
				};

				$.if(node_2, ($$render) => {
					if (app.inspectorTab === 'connection') $$render(consequent_2); else $$render(alternate_2, -1);
				});
			}
		...
		$.if(node_1, ($$render) => {
			if (app.provider) $$render(consequent_3); else $$render(alternate_3, -1);
		});
	}
	...
	$.delegated('click', button, () => app.inspectorTab = 'connection');
	$.delegated('click', button_1, () => app.inspectorTab = 'browser');
