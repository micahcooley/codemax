...
var root = $.from_html(`<aside aria-label="Workspace sidebar"><div class="workspace-title"><span class="workspace-logo"><!></span><span><strong>Codemax</strong><small>Browse. Discover. Connect.</small></span></div> <div class="sidebar-section"><span class="label">Browser tabs</span><span class="spacer"></span><span class="count"> </span></div> <div class="site-list"><!> <button class="site-add" aria-label="Add website"><!><span>Add website</span></button></div> <nav class="workspace-nav" aria-label="Workspace tools"></nav> <div class="sidebar-bottom"><button title="Settings"><!><span>Settings</span></button><button title="Command palette"><!><span>Commands</span><!></button><div class="local-note"><!><span>Private profiles. Local gateway.</span></div></div></aside> <!>`, 1);
