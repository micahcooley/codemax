const OPENAI_GPT5 = { url: 'https://developers.openai.com/api/docs/models/gpt-5', retrieved: '2026-09-23' };
const OPENAI_GPT5_MINI = { url: 'https://developers.openai.com/api/docs/models/gpt-5-mini', retrieved: '2026-09-23' };
const ANTHROPIC_CTX = { url: 'https://platform.claude.com/docs/en/build-with-claude/context-windows', retrieved: '2026-09-23' };
const GOOGLE_25_PRO = { url: 'https://ai.google.dev/gemini-api/docs/models/gemini-2.5-pro', retrieved: '2026-09-23' };
const GOOGLE_25_FLASH = { url: 'https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash', retrieved: '2026-09-23' };
const XAI_MODELS = { url: 'https://docs.x.ai/docs/models', retrieved: '2026-09-23' };
const ALIBABA_QWEN3_MAX = { url: 'https://help.aliyun.com/en/model-studio/model-qwen3-max', retrieved: '2026-09-23' };
const ALIBABA_QWEN3_235B = { url: 'https://help.aliyun.com/en/model-studio/qwen3-235b-a22b', retrieved: '2026-09-23' };
const MOONSHOT_K2 = { url: 'https://platform.moonshot.ai/docs/guide/kimi-k2-quickstart', retrieved: '2026-09-23' };
const ZHIPU_MODELS = { url: 'https://open.bigmodel.cn/dev/howuse/model', retrieved: '2026-09-23' };
const DEEPSEEK_DOCS = { url: 'https://api-docs.deepseek.com/', retrieved: '2026-09-23' };
const DEEPSEEK_R1 = { url: 'https://github.com/deepseek-ai/DeepSeek-R1', retrieved: '2026-09-23' };
const MISTRAL_LARGE3 = { url: 'https://docs.mistral.ai/models/mistral-large-3-25-12', retrieved: '2026-09-23' };
const MISTRAL_MEDIUM3 = { url: 'https://docs.mistral.ai/models/mistral-medium-3-25-05', retrieved: '2026-09-23' };
const MINIMAX_TABLE = { url: 'https://platform.minimax.io/docs/guides/text-generation', retrieved: '2026-09-23' };
const PERPLEXITY_SONAR = { url: 'https://docs.perplexity.ai/docs/sonar/models/sonar', retrieved: '2026-09-23' };
const META_LLAMA4 = { url: 'http://llama.com/docs/model-cards-and-prompt-formats/llama4', retrieved: '2026-09-23' };
const OPENAI_PRICING = { url: 'https://openai.com/chatgpt/pricing', retrieved: '2026-09-23' };
const OPENAI_SOL_BLOG = { url: 'https://openai.com/index/improving-gpt-5-6-sol-in-chatgpt/', retrieved: '2026-09-23' };
const OPENAI_HELP_BUSINESS = { url: 'https://help.openai.com/en/articles/12003714-chatgpt-business-models-limits.md', retrieved: '2026-09-23' };
const CLAUDE_TUTORIAL = { url: 'https://claude.com/resources/tutorials/choosing-the-right-claude-model', retrieved: '2026-09-23' };
const CLAUDE_CTX_1M = { url: 'https://platform.claude.com/docs/en/build-with-claude/context-windows', retrieved: '2026-09-23' };
const GEMINI_SUBS = { url: 'https://gemini.google/subscriptions', retrieved: '2026-09-23' };
...
function boundaryMatch(haystack, pattern) {
    let from = 0;
    while (true) {
...
export function catalogLookup(id, displayName) {
