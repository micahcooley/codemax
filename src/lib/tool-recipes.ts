 ...
 */
export interface ToolRecipe {id:string;label:string;description:string;icon:string;command:string;args:string[];folder?:boolean;note:string;version:string;}
...
export function recipeDefinition(id:string,folder=''):{label:string;command:string;args:string[]} {
