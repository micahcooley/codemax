...
(()=>{
 ...
 const provider=(id,label,origin,state,models=[])=>({detected:state==='READY',exposed:true,scan_enabled:true,dismissed:false,discovery_score:state==='READY'?9:0,discovery_reason:state==='READY'?'UI fixture: independent composer, model and conversation evidence':'No provider evidence; browsing only',current_model:state==='READY'?'fixture-reasoner':'',reasoning_modes:state==='READY'?[{value:'normal',label:'Normal'},{value:'thinking',label:'Thinking'}]:[],id,label,origin,url:origin+'/',current_url:origin+'/',state,open_tab:true,pinned:false,active:false,browser_busy:false,last_seen:now,mapping_version:state==='READY'?12:0,last_error:'',context_hint:0,reasoning_value:'',models,mappings:{prompt:8,send:12,response:5,stop:13,new_chat:2,model:3,reasoning:10,attachment:9,ephemeral:0},model_locked:false,reasoning_locked:false});
